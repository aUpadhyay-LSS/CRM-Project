...
//Login disaabled for cookie cutter
$_SESSION['Username'] = "support@lssoftwaresolutions.com";
...
//
//
//$result = mysql_query("SELECT gfe,ac,nyc,ctic FROM client_configuration where client_id ='8'");
...
<div class='middle'>
  <div class="container">
	...
	<tr><td><b>State:</b></td>
	<td><select id="state" name="state" value="NA" onchange= countyswitch()>
	...
	<tr><td><b>County:</b></td>
	<td><select name="county" id="county" onchange= townSwitch()>
...
// Disabled for cookie cutter dev
//} else{
//
...
//{
//  $_SESSION['lastref']="http://localhost/CookieCutter_Dev/GFE_main.php";
//}
//
